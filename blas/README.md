# Gonum BLAS [![GoDoc](https://godoc.org/github.com/jingcheng-WU/gonum/blas?status.svg)](https://godoc.org/github.com/jingcheng-WU/gonum/blas)
...
## Installation
```sh
  go get github.com/jingcheng-WU/gonum/blas/...
```
